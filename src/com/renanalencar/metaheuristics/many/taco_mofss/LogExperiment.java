...
public class LogExperiment {
     ...
     public static BufferedWriter f_m_standard_deviation; // desvião padrão de cada iteração
     public static BufferedWriter f_m_max_cost;           // custo máximo de cada iteração
