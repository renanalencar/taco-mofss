package upe.poli.ecomp.problem;

public abstract class Problem {

	protected int dimensions;
	private int fitnessEvaluationNumber;
	 ...
	 *         .
	 */
	public abstract boolean isFitnessBetterThan(double currentSolutionFitness,
	...
	public int getFitnessEvaluationNumber() {
		return fitnessEvaluationNumber;
	}

	public void setFitnessEvaluationNumber(int fitnessEvaluationNumber) {
		this.fitnessEvaluationNumber = fitnessEvaluationNumber;
	}
}