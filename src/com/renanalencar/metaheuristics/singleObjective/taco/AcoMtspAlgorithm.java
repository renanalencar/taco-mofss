...
public class AcoMtspAlgorithm implements ControlExperiment, ControlSTACS {
    ...
    private AcsAlgorithm AntColonySystem; // rotinas do algoritmo com.renanalencar.metaheuristics.singleObjective.taco.Ant com.renanalencar.metaheuristics.singleObjective.taco.Colony System
    ...
    //private com.renanalencar.metaheuristics.singleObjective.taco.Utilities util;                  // funções auxiliares
    ...
    public AcoMtspAlgorithm(long seed_random, MtspInstance instance) {
        ...
        //util = new com.renanalencar.metaheuristics.singleObjective.taco.Utilities();
