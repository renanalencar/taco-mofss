...
package com.renanalencar.experiments.studies;
 ...
 */
public class SingleObjectiveStudy extends Experiment {
...
//        algorithm[4] = new GDE3_Settings(problemName).configure(parameters[4]);
      ...
      Logger.getLogger(SingleObjectiveStudy.class.getName()).log(Level.SEVERE, null, ex);
  ...
  public static void main(String[] args) throws JMException, IOException {
    SingleObjectiveStudy exp = new SingleObjectiveStudy();
